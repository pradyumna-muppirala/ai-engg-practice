...
def merge_sort(arr: list) -> list:
    """Merge sort implementation using Python 3.11+ type hints.
...
# Merge sort example
numbers_to_sort = [64, 34, 25, 12, 22, 11, 90, 91, 33, 56, 67, 34]
sorted_merge = merge_sort(numbers_to_sort)
print(f"Merge sorted list: {sorted_merge}")
